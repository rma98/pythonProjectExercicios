...
mensagem = '\033[34mEmpréstimo pode ser CONCEDIDO!\033[m' if prestacao <= minimo else '\033[35mEmpréstimo NEGADO!\033[m'
print(f'Para pagar uma casa de \033[32mR${valor_da_casa:.2f}\033[m em \033[33m{anos}\033[m anos, a prestação será de '
      f'\033[31mR${prestacao:.2f}\033[m\n{mensagem}')
...
mensagem = 'Empréstimo pode ser CONCEDIDO!' if prestacao <= minimo else 'Empréstimo NEGADO!'
print('Para pagar uma casa de R${:.2f} em {} anos, a prestação será de R${:.2f}\n{}'.format(valor_da_casa, anos, prestacao, mensagem))
